 ...
 ******************************************************/
 ...
 --- same as above, but now in ANSI SQL-92 syntax - the recommended model
 ...
 ******************************************************/
 ...
 SELECT *
	...
	-- LEFT OUTER JOIN [Positions] AS p ON n.NumberID = p.PositionNo
 GO
 ...
 ******************************************************/
 ...
 -- ANSI SQL 92 standard - INNER JOIN
 SELECT a.ID AS [ManagerId],
        a.EmployeeName AS [ManagerName],
		a.Designation AS [ManagerDesignation],
		a.ManagerID AS [ReportingManagerID],
		...
		b.Designation AS [EmployeeDesignation]
 FROM [Employees] AS a
	  JOIN [Employees] AS b ON a.ID = b.ManagerID
 GO

 -- ANSI SQL 89 standard - INNER JOIN
