 ...
 ******************************************************/
 ...
 IF (EXISTS (SELECT *
                 ...
                 WHERE TABLE_CATALOG = 'MyDemoDb'
                  ...
                  AND TABLE_NAME = 'Customers3'))
 BEGIN
    DROP TABLE [dbo].[Customers3]
 END
 GO
 ...
 /*
 *   The SQL Server specific way of Dropping a Table
 ******************************************************/
 ...
 ******************************************************/
 ...
 SELECT *
	FROM [Orders]
	WHERE [OrderDate] >= '1996-07-05' AND [OrderDate] <= '1996-07-10'
	ORDER BY [OrderDate]
 ...
 ******************************************************/
 ...
 SELECT COUNT( ALL [Region] )
	 FROM [Suppliers]
 SELECT COUNT( DISTINCT [Region] )			-- Quebec has two records!
	 FROM [Suppliers]
 GO
 ...
 ******************************************************/
 ...
 --- Example #2: get the top 10 percent of rows
 ...
 ******************************************************/
 ...
 CREATE TABLE [Persons] (
    [ID] smallint NOT NULL IDENTITY(101,1)
    , [Name] nvarchar(50) NOT NULL
    , [Age] int NULL
	, [Country] varchar(50) NOT NULL
		    -- CONSTRAINT [CHK_Persons_Country] CHECK ( [Country] IN ('India', 'USA') )
	...
	, CONSTRAINT [CHK_Persons_AgeLimit]
			...
			CHECK ( ([Age] BETWEEN 18 AND 60) AND [Country] = 'India' )
 )
 GO
 ...
 ******************************************************/
 ...
 ---- Example #3
 DECLARE @sortDesc varchar(50) = '[CustomerID] DESC'
 SELECT [CustomerID], [CompanyName], [City], [Country]
	FROM [Customers]
	...
	ORDER BY 
		...
		, (CASE
			...
			WHEN [Country] = 'France' THEN @sortDesc
		END)
 GO
