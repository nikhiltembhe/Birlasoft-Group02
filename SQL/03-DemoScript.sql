 ...
 ******************************************************/
 ...
 SELECT COUNT([CustomerID]) AS [NumberOfCustomers], [Country]
	FROM [Customers]
	GROUP BY [Country]
	ORDER BY COUNT([CustomerID]) DESC			-- formula
 SELECT COUNT([CustomerID]) AS [NumberOfCustomers], [Country]
	FROM [Customers]
	GROUP BY [Country]
	ORDER BY [NumberOfCustomers] DESC			-- alias of the computed column
 GO
 ...
 SELECT [Customers].[CustomerID]
	...
	GROUP BY
		...
		, [Customers].[CompanyName]			-- try commenting it to see the Error
 GO
 ...
 ******************************************************/
 ...
 SELECT [Customers].[CustomerID]
    ...
    FROM [Orders]
		 LEFT JOIN [Customers] ON [Orders].[CustomerID] = [Customers].[CustomerID]
	WHERE [Customers].[Country] = 'France' OR [Customers].[Country] = 'Sweden'
